...
public class DateAndTime_02_Test {
    ...
    public void test_with() {
        ...
        LocalDate resultMonth = localDate.with(ChronoField.DAY_OF_MONTH, 05);
        LocalDate resultyear = resultMonth.withYear(2015);
        LocalDate result = resultyear.plus(1, ChronoUnit.MONTHS);
